...
| Элемент | Метафора | Применение в UI |
| :--- | :--- | :--- |
| Лёд | Свежее поле, плитка, конденсат | Фон карточек, градиенты, noise-текстура |
| Шайба | Диск, импульс, скольжение | CTA-кнопки, индикатор активной вкладки |
| Клюшка / атака | Диагональ слева-направо | Композиция ленты, направление анимаций |
| Табло | LED-цифры, счёт, таймер | Karma, состав, календарь, загрузка |
| Софиты | Верхний свет, тёмные края | Hero, тёмная тема, night league |
| Сетка ворот | Ячейки, пустое состояние | Empty states, фильтры вратарей |
| Раздевалка | Шевроны, крючки, форма | Профиль команды, карточка игрока |
